...
/** class implementation for cell representation
 *
 * Conventions
 * int board[][] //The board represents the two-dimensional representation of the cells
 * board[1][2] = 1; // cell at (1,2) is live
 * board[2][4] = 0; // cell at (2,4) is dead
 */
...
public class CellRepresentation {
     ...
     * the state of the cell at that specific position to live **/
    ...
    /** Function to take the user input in the form of row and column to change
     * the state of the cell at that specific position to dead **/
    ...
    public static void main(String args[]){
        ...
        System.out.println("Please Enter any number out of the row size to go to the next step");
        System.out.print("Row No: ");
        ...
        System.out.println("Please Enter any number out of the row size to see the current generation and next generation");
        System.out.print("Row No: ");
